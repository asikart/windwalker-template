 ...
 */
class CustomerModelResponseList extends AKModelList
{
	/**
    ...
    {
        $config['filter_fields'] = CustomerHelper::_('query.mapAPIFilterFields', $config['filter_fields'] , $this->list_name );
    ...
    {
        $result     = new JObject();
        $cache_path = JPATH_CACHE.'/customer/list_hash' ;
