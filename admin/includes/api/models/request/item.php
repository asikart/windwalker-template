 ...
 * Schedule model.
 */
class iHealthCustomerSDKModelItem extends AKModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 * @since	1.6
	 */
	protected 	$text_prefix = 'COM_SCHEDULE';
	
	public 		$component = 'schedule' ;
	public 		$item_name = 'resident' ;
	public 		$list_name = 'residents' ;
	public      $request_item = '';
    public      $request_list = '';
