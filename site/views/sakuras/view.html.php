...
class FlowerViewSakuras extends AKViewList
{
	...
	public function display($tpl = null)
	{
		...
		foreach ($this->items as &$item)
		{
			...
			// Link
			// =====================================================================================
			$item->link = new JURI("index.php?option=com_flower&view=sakura&id={$item->a_id}");
		...
		if ($active)
		{
			...
			if (!strpos($currentLink, 'view=sakuras') || !(strpos($currentLink, 'id=' . (string) $this->category->id)))
			{
