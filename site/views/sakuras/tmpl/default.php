...
FlowerHelper::_('include.bootstrap', true);
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_flower&view=sakuras'); ?>" method="post" name="adminForm" id="adminForm">
    
    <div id="flower-wrap" class="windwalker list container-fluid sakuras<?php echo $this->get('pageclass_sfx');?>">
        <div id="flower-wrap-inner">
            ...
            <?php if ($this->params->get('show_description', 1) || $this->params->def('show_description_image', 1)) : ?>
                ...
                <?php if ($this->params->get('show_description') && $this->category->description) : ?>
                    <?php echo JHtml::_('content.prepare', $this->category->description, '', 'com_flower.category'); ?>
                <?php endif; ?>
                <div class="clr"></div>
                </div>
            <?php endif; ?>
